...
Update progress can be consulted locally using the [ctrl steps endpoint](../reference/pantavisor-commands.md#steps).
...
Finally, our garbage collector can be triggered on demand issuing a [command](../reference/pantavisor-commands.md#commands) through Pantavisor control socket.
