...
With local control, we mean the control that is performed from one of the [containers](containers.md) running in the [revision](revisions.md) using the [control socket](../reference/pantavisor-commands.md), which offers an HTTP REST API to control and monitor Pantavisor.

This kind of control can be performed even if the device is already [claimed in Pantacor Hub](remote-control.md#pantacor-hub). It can also be the only option if you [disable remote control](../reference/pantavisor-configuration.md#summary) or if you install a [local revision](../reference/pantavisor-commands.md#steps) at any given time, which will interrupt Pantacor Hub remote control unless a [go remote command](../reference/pantavisor-commands.md#commands) is issued. This behavior can be avoided with the [remote always configuration](../reference/pantavisor-configuration.md#summary).

## Available Operations

The [control socket](../reference/pantavisor-commands.md) exposes a REST API for managing the device from within a container. Key operations include:

* [List and manage containers](../reference/pantavisor-commands.md#containers) — query status, [stop/start/restart](containers.md#lifecycle-control) individual containers with [restart_policy](containers.md#restart-policy) "container"
* [Send signals](../reference/pantavisor-commands.md#signal) — report [readiness](containers.md#signals) to Pantavisor
* [Issue commands](../reference/pantavisor-commands.md#commands) — [reboot](../reference/pantavisor-commands.md#commands), run revisions, trigger [updates](updates.md)
* [Manage metadata](../reference/pantavisor-commands.md#user-meta) — read and write user/device metadata
* [Manage steps](../reference/pantavisor-commands.md#steps) — install and query [revisions](revisions.md)
* [Manage daemons](../reference/pantavisor-commands.md#daemons) — start/stop internal Pantavisor daemons
* [Query service mesh](../reference/pantavisor-commands.md#xconnect-graph) — inspect the [xconnect](xconnect.md) graph
