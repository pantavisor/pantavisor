...
#define PV_USER_META_KEY_PATHF      "%s"PV_USER_META_PATH"/%s"
#define PV_USER_META_PLAT_PATHF     "%s"PV_USER_META_PATH".%s"
#define PV_USER_META_PLAT_KEY_PATHF "%s"PV_USER_META_PATH".%s/%s"
