...
LOCAL_LIBRARIES := libthttp mbedtls picohttpparser zlib lxc libevent
...
LOCAL_CMAKE_CONFIGURE_ARGS += "-DPANTAVISOR_RUNTIME=ON"
LOCAL_CMAKE_CONFIGURE_ARGS += "-DPANTAVISOR_PVTX=ON"
LOCAL_CMAKE_CONFIGURE_ARGS += "-DPANTAVISOR_PVTX_STATIC=OFF"
